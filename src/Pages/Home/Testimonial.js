            ...
            <div className="relative max-w-[85rem] px-4 mx-auto">
                ...
                <div className="mb-6 sm:mb-10 md:mb-16">
                    <div className="flex flex-col md:flex-row items-center justify-between w-full space-y-4">
                        <h2 className="text-6xl bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent font-bold">
                            Testimonials
                        </h2>
                        <div className="bg-blue-300 ml-4 h-0.5 md:w-full w-0"></div>
                    </div>
                ...
                {/* Stats Grid */}
                <div className="md:mt-20 mt-10 flex flex-wrap gap-6 sm:gap-12 lg:gap-8">
                    <div className="flex-1">
                        <h4 className="text-lg sm:text-xl font-semibold text-gray-500">
                            Accuracy Rate
                        </h4>
                        <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl  bg-clip-text font-semibold bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">
                            99.95%
                        </p>
                        <p className="mt-1 text-gray-400">In Fulfilling Orders</p>
                    </div>
                    <div className="flex-1">
                        <h4 className="text-md md:mt-0 mt-1 md:text-xl font-semibold text-gray-500">
                            Startup Businesses
                        </h4>
                        <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl  bg-clip-text font-semibold bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">
                            2000+
                        </p>
                        <p className="mt-1 text-gray-400">Partner Connected </p>
                    </div>
                    <div className="flex-1">
                        <h4 className="text-lg sm:text-xl font-semibold text-gray-500">
                            Happy Customer

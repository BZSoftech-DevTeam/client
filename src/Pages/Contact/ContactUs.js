    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <div className="max-w-2xl lg:max-w-5xl mx-auto">
        <div className="text-center mb-2">
          <h2 className="w-full text-3xl sm:text-4xl md:text-5xl lg:text-6xl bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent font-bold">
            Contact us
          </h2>
        ...
        <div className="mt-8 sm:mt-12 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16">
          {/* <!-- Card --> */}
          <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
            <h2 className="mb-6 sm:mb-8 text-lg sm:text-xl font-semibold text-gray-800 dark:text-neutral-200">
              Fill in the form
            </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="py-2 sm:py-3 px-3 sm:px-4 block w-full border-gray-200 rounded-lg text-xs sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none outline-none"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="outline-none py-2 sm:py-3 px-3 sm:px-4 block w-full border-gray-200 rounded-lg text-xs sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
